...
namespace Task_7.AI
{
    public class Wander : AIMovement
    {
        ...
        public override Task_7.AI.SteeringOutput GetKinematic(Task_7.AI.AIAgent agent)
        {
            Task_7.AI.SteeringOutput output = base.GetKinematic(agent);
        ...
        public override Task_7.AI.SteeringOutput GetSteering(Task_7.AI.AIAgent agent)
        {
            _island = agent.island.transform;
            Task_7.AI.SteeringOutput output = base.GetSteering(agent);
